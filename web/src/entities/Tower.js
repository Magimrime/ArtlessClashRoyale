...
export default class Tower extends Entity {
    ...
    act(g) {
        ...
        const valid = e => e && e.hp > 0 && e.tm !== this.tm && g.ents.includes(e) && !e.isGhosted && !e.teslaHidden && !(e.sjT > 0) &&
        ...
        if (best) {
            // Crown-tower hit: 109 damage. Reload tuned slow enough that fragile
